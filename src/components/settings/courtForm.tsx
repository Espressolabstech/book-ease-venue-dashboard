...
const CourtForm = ({
    ...
    return (
        <div className="space-y-4">
            ...
            {/* Environment pills — hidden for locked sports (Table Tennis, Squash) */}
            {!locked && (
                <div>
            ...
            {/* Format (Football, Cricket) — placed before Surface per spec */}
            {formatOptions && (
                <div>
            ...
            {/* Court size — Basketball only, pill selector per spec */}
            {courtSizeOptions && (
                <div>
            ...
            {/* Surface — only shown when options exist */}
            {surfaces.length > 0 && (
                <div>
